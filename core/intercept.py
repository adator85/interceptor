...
class Intercept:
    ...
    def __init__(self, base: base.Base, parser: parser.Parser, subprocess:Popen, subprocess_detail:dict) -> None:
        ...
        self.global_sys_attempt         = 4          # Number of attempt for the jail
        self.global_sys_jail_duration   = 30         # Duration in seconds before the release
    ...
    def get_service_id(self, output:str) -> int:
